...
export class DashboardComponent implements OnInit {
  ...
  public ChartQuery = {
    ...
    measures: ["TimesheetData.IntEquivalent"],
    dimensions: ["TimesheetData.projectname", "TimesheetData.monthyear"],
    segments: ['TimesheetData.SATaxi'],
    timeDimensions: [],
    filters: [
      {
        "member": "TimesheetData.monthyear",
        "operator": "contains",
        "values": [
          "202"
        ]
